...
if(!isset($_SESSION['shop_id'])){
  echo "<script> alert('Login As Shop Owner')</script>";
  header("refresh:0; url=shop_join.php");
}
...
<body>
  ...
  <main id="main">
    ...
    <div class="row">
        ...
        <div class="member" data-aos="zoom-in">
          <img src="assets/img/team/team-1.jpg" class="img-fluid" alt="" style="border-radius:100px;">
              <div class="member-info">
                 <h4>Stock Point Id: <?php echo $shop_id; ?> </h4>
      ...
      <div class="col-sm-6">
         <div class="card">
        <h3>Edit Stock Point Details</h3>
        <form action="edit_shop_form.php">
        <button class="btn btn-secondary" name="userdetails">Edit</button>
        </form>
        </div>
      </div>
      ...
      <div class="col-sm-6">
         <div class="card">
        <h3>Add Money</h3>
        <form action="shop_add_money.php">
      ...
      <div class="col-sm-6">
         <div class="card">
        <h3> Admin Orders </h3>
        <form action="shop_admin_orders.php">
        <button class="btn btn-secondary" name="purchasehist">View</button>
        </form>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        ...
        <form action="shop_admin_offers.php">
        <button class="btn btn-secondary" name="purchasehist">View</button>
        </form>
        </div>
      </div>
