    ...
    <div class="row">
				<div class="col-6">
								<div class="card m-3 mt-5 bg-light p-2">
									...
									<center><h3>
										<?php 
										$sql="select count(*) as total from signup_details";
							...
							<div class="col-6">
								<div class="card m-3 mt-5 bg-light p-2">
									...
									<center><h3>
										<?php 
										$sql="select sum(balance) as total from payout";
										$result = $conn->query($sql);
										if ($result->num_rows > 0) 
					                      {
					                      // output data of each row
							...
							<div class="col-6">
								<div class="card m-3 mt-5 bg-light p-2">
									<center><h4>Number of Green id's :</h4></center>
									<center><h3>
										<?php 
										$sql="select sum(stat='GREEN') as total from payout";
										$result = $conn->query($sql);
										if ($result->num_rows > 0) 
					                      {
					                      // output data of each row
							...
							<div class="col-6">
								<div class="card m-3 mt-5 bg-light p-2">
									<center><h4>Number of RED id's :</h4></center>
									<center><h3>
									<?php 
										$sql="select sum(stat='RED') as total from payout";
										$result = $conn->query($sql);
										if ($result->num_rows > 0) 
					                      {
					                      // output data of each row
