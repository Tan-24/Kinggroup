      ...
      <div class="row">
				<div class="col-6 offset-md-1 offset-xg-2">
								<div class="card m-2 mt-2 bg-light p-1">
									<center><br>
									<label><h3>Details Of Purchase : </h3></label><br><br>
                 <label><h5>Associate Id : <?php echo $_SESSION['uid']; ?></h5></label><br>
                 <label><h5>Transaction ID : <?php echo $pid; ?></h5></label><br>
                 <label><h5>Transaction Amount : <?php echo $amount2; ?></h5></label><br>
                 <label><h5>Remaining Balance : <?php echo $balance; ?></h5></label><br>
                 <label><h5>Total Purchase Till now : <?php echo $purchase; ?></h5></label>
