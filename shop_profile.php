        ...
        <div class="row">
          <div class="col-6 offset-md-1 offset-xg-2">
            <div class="card m-3 mt-5 bg-light p-2"><br>
              <label>
                <h3><b>Your Stock Point Details : </h3>
              </label>
              <label>Owner Name: <?php echo $ownername; ?> </label><br>
              <label>Stock Point Id: <?php echo $shop_id; ?> </label><br>
              <label>Mobile Number: <?php echo $mobile; ?> </label><br>
              <label>Pan Card No.: <?php echo $pan; ?> </label><br>
              <label>UAM No: <?php echo $uam; ?> </label><br>
              <?php
              if (!empty($email)) {
              ?>
                <label>Email: <?php echo $email; ?> </h3></label><br>

              <?php
              }
              ?>
              <label>signnature:<br><img style="height:10vh;object-fit: contain; width: 60%;" src="img/<?php echo $signnature;?>"> </h3></label><br><br>
