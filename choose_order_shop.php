...
if (isset($_POST['assign'])) {
    ...
    $q = "insert into admin_orders(amount,stock_point,time,date,status) values('$amount','$shop_id',now(),now(),'accepted')";
    $update = mysqli_query($conn, $q);
    if ($update) {
        echo "<script> alert('Order Assigned')</script>";
    header("refresh:0; url=admin_orders.php");
    }
}
?>
            ...
            <div class="container" style="margin-top: 100px;">
                ...
                <div class="row">
                    ...
                    if (isset($_POST['assign_order'])) {
                        $value = mysqli_real_escape_string($conn, $_POST['order_amount']);
                    } else {
                        header("refresh:0; url=admin_orders.php");
                    }
                                ...
                                <div class="card" style="padding: 20px;">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <form method="POST" action="choose_order_shop.php">
                                                <input type="hidden" name="shop_id" value="<?php echo $shop_id; ?>">
                                                <input type="hidden" name="amount" value="<?php echo $value; ?>">

                                                <button class="btn btn-secondary" id="buy" name="assign" type="submit">Select</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
